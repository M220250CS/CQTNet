...
def multi_train(**kwargs):
    ...
    train_dataloader0 = DataLoader(train_data0, opt.batch_size, shuffle=True, num_workers=opt.num_workers, collate_fn=my_collate_fn)
    train_dataloader1 = DataLoader(train_data1, opt.batch_size, shuffle=True, num_workers=opt.num_workers, collate_fn=my_collate_fn)
    train_dataloader2 = DataLoader(train_data2, opt.batch_size, shuffle=True, num_workers=opt.num_workers, collate_fn=my_collate_fn)
    val_dataloader = DataLoader(val_data, 1, shuffle=False, num_workers=1, collate_fn=my_collate_fn)
    test_dataloader = DataLoader(test_data, 1, shuffle=False, num_workers=1, collate_fn=my_collate_fn)
    val_dataloader80 = DataLoader(val_data80, 1, shuffle=False, num_workers=1, collate_fn=my_collate_fn)
